...
public final class login_005flms_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write('\n');
        ...
        if (request.getParameter("submit") != null) {
            char c = request.getParameter("post").charAt(0);
            int id = Integer.parseInt(request.getParameter("id"));
            DAO d = new DAO();
            if (d.login(c, id)) {
                session.setAttribute("lms", c);
                session.setAttribute("lmsId", id);
                response.sendRedirect("home_lms.jsp");
            }
        }
      ...
      out.write("                                    <li class=\"breadcrumb-item active\" aria-current=\"page\">Login In Library</li>\n");
      out.write("                                </ol>\n");
      out.write("                            </nav>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      ...
      out.write("                <select name=\"post\" class=\"form-control col-lg-4\">\n");
      out.write("                    <option value=\"s\">Student</option>\n");
      out.write("                    <option value=\"f\">Staff</option>\n");
      out.write("                </select>\n");
      out.write("                <br/>\n");
      out.write("                <input type=\"number\" name=\"id\" placeholder=\"Please enter your Library Membership Id\" class=\"form-control col-lg-4\"/><br/>\n");
      out.write("                <input type=\"submit\" name=\"submit\" value=\"Login\" class=\"btn btn-outline-danger col-2\"/>\n");
      out.write("            </form>\n");
      out.write("        </div>\n");
      out.write("\n");
      out.write("        <!-- jQuery js -->\n");
