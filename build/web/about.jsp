<%-- 
    Document   : about
    Created on : 16-Mar-2020, 17:22:55
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <img style="border-radius:0px 200px 0px 200px; " src="img/admin.jpg"/>
                </div>
                <div class="col-lg-2"></div>
                <div class="col-lg-5">
                    <br/><br/>
                    <h1 style="font-family:monospace;color:teal;">Ravikumar Makwana</h1>
                    <p align="justify" style="font-family:monospace;text-indent:50px;">
                        I am study in Computer Engineering in VVP Engineering Colleg.
                    </p>
                    <br/>
                    <p align="justify" style="font-family:monospace;text-indent:50px;">
